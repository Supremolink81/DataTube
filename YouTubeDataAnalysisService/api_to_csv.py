...
def remove_duplicates_from_csv(filename: str) -> None:
    ...
    csv_as_dataframe: pd.DataFrame = pd.read_csv(filename, index_col=False)
...
if __name__ == "__main__":
    ...
    asyncio.run(place_youtube_videos_in_csv_file(450, "YouTubeDataAnalysisService/youtube_video_data.csv", overwrite=False))